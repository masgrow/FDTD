...
def init_values(material_lib):
    ...
    parser.add_argument('--rad', metavar='radius', type=float, default=0.2,
                        help='Radius nanoparticle a*rad (default: 0.03 um')
    parser.add_argument('--fcen', metavar='frequency', type=float, default=0.01,
                        help='The center frequency f (c/distance or ω in units of 2πc/distance) (default: 0,256410256)')
    parser.add_argument('--df', metavar='fwidth', type=float, default=0.01,
    ...
    parser.add_argument('--t', metavar='time', type=float, default=100,
